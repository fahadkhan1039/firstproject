<div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            data-kt-scroll-offset="0" style="height: 166px;">
            <!--begin::Menu-->
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                id="kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                <!-- Dashboards Menu -->
                <div data-kt-menu-trigger="click"
                    class="menu-item {{ request()->is('home') || request()->is('users') ? 'here show menu-accordion' : '' }}">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('home') ? 'active' : '' }}" href="/home">
                                ...
                                <span class="menu-title">Insert Form</span>
                            </a>
                        </div>
                        <div class="menu-item">
